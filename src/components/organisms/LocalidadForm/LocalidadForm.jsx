    ...
    return (
      <div className="flex items-center justify-center h-full">
        ...
        >
          ...
          <div className="mb-4">
            <StyledInput name="nombre" type="text" label="Nombre" id="textInput" placeholder="Nombre de localidad" value={inputValue} onChange={handleInputChange} required minLength={1}/>
          </div>
